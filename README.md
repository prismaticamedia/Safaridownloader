...
This project is a modified and enhanced version based on the original project: [safaribooks by lorenzodifuccia](https://github.com/lorenzodifuccia/safaribooks). 
It features a graphical UI built with PyQt6, the ability to convert generated EPUBs to clean PDFs, Cloudscraper integration to bypass Cloudflare protection, and several formatting fixes for image rendering and page numbers.

### Disclaimer from the original project:
